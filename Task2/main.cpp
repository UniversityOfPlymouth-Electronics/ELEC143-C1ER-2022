...
int main()
{
    ...
    // 1. Using a while-loop, count from 0 upto (and including) 21, in steps of 3 - print the results to the serial terminal

    // 2. The code below asks the user to enter a number from 0 upto (and including) 99.

...
int main()
{
    ...
    while (true)
    {
        ...
        // PLEASE NOTE - this codeo only compiles with the standard Arm Compiler (does not work with GCC)
        ...
        //        To save memory, find and remove the repeated section from the array above

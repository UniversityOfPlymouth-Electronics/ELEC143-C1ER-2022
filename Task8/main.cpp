...
void display34Array(const double U[3][4])
{
...
void transpose(const double U[3][4], double Y[4][3])
{
    //YOUR CODE HERE
}
...
int main()
{
    ...
    //    Note that the dimensions of Qt will be 4x3
    double Qt[4][3];
